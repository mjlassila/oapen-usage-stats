...
Let's create some basic descriptive tables to check the structure of the data. Having read the article, we know the range of values variables should have.
